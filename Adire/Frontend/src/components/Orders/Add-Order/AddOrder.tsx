...
const validationSchema = Yup.object().shape({
  ...
  ProjectDuration: Yup.string().required('ProjectDuration is required'),
  Price: Yup.number().required('Price is required'),
  DueDate: Yup.date().required('DueDate is required'),
  OrderImages: Yup.array().required('OrderImages is required'),
  Measurement: Yup.object().shape({
    Chest: Yup.number().required('Chest is required'),
    Shoulder: Yup.number().required('Shoulder is required'),
    Back: Yup.number().required('Back is required'),
    Neck: Yup.number().required('Neck is required'),
    UnderBust: Yup.number().required('UnderBust is required'),
    ArmHole: Yup.number().required('ArmHole is required'),
    HalfLength: Yup.number().required('HalfLength is required'),
    Waist: Yup.number().required('Waist is required'),
    TrouserWaist: Yup.number().required('TrouserWaist is required'),
    Hip: Yup.number().required('Hip is required'),
    Thighs: Yup.number().required('Thighs is required'),
    SleeveLength: Yup.number().required('SleeveLength is required'),
    Wrist: Yup.number().required('Wrist is required'),
    Calf: Yup.number().required('Calf is required'),
    Ankle: Yup.number().required('Ankle is required'),
    TrouserLength: Yup.number().required('TrouserLength is required'),
    FullLength: Yup.number().required('FullLength is required'),
  }),
});
...
const isDisabledSchema = Yup.object().shape({
  ...
  DueDate: Yup.date().required('DueDate is required'),
  OrderImages: Yup.array().required('OrderImages is required'),
  MaterialType: Yup.string().required('MaterialType is required'),
  Measurement: Yup.object().shape({
    Chest: Yup.number().required('Chest is required'),
    Shoulder: Yup.number().required('Shoulder is required'),
    Back: Yup.number().required('Back is required'),
...
const CreateOrder = async (formData: any) => {
  const response = await axios.post(
    `${apiUrl}/adire/order/createorder`,
    formData,
    {
      headers: {
          ...
          <div className={styles['frame-16631']}>
            <div className={styles['frame-16477']}>
              <div className={styles['frame-16474']}>
                <div className={styles['create-new-order']}>
                  Create New Order
                </div>
                <div
                  className={
                ...
                {expanded ? (
                      ...
                      <div className={styles['button-default221']}>
                        ...
                        >
                          {isLoading ? (
                            ...
                            <div className={styles.text55}>Create Order</div>
                          )}
                        </button>
                      </div>
                    </div>
                  ...
                  <div className={styles['frame-16630']}>
                    ...
                    <div className={styles['button-default221']}>
                      ...
                      >
                        {isLoading ? (
                          <div className={styles.text55}>Adding Order....</div>
                        ) : (
                          <div className={styles.text55}>Create Order</div>
                        )}
                      </button>
